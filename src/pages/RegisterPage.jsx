...
import { LayoutGrid, TrendingUp, Bell, CheckSquare, Plus, AlertCircle, Eye, EyeOff } from 'lucide-react'
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    onChange={handleChange}
                    className={`w-full rounded-xl border ${errors.confirmPassword ? 'border-red-400' : 'border-gray-200'} bg-white pl-4 pr-12 py-3 text-[#2D2D3F] outline-none focus:border-[#6d5bd0] focus:ring-2 focus:ring-[#6d5bd0]/20`}
                    style={{ fontFamily: 'Nunito, sans-serif', fontSize: '0.875rem' }}
                  />
                  <button
                    type="button"
